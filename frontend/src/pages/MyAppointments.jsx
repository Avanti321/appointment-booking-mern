      ...
      handler: async (response) => {
        try {
          ...
          if (data.success) {
            ...
            getUserAppointments()  // ✅ refresh to show payment:true
          } else {
            toast.error(data.message)
          }
        } catch (error) {
        ...
        {appointments.map((item, index) => (
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            ...
            <div className='flex-1 text-sm text-zinc-600'>
              ...
              <p className='text-xs'>{item.docData.address.line2}</p>  {/* ✅ fixed line2 */}
            ...
            <div className='flex flex-col gap-2 justify-end'>
              ...
              {/* Show Payment Done if already paid */}
              ...
              {/* Show Pay Online only if NOT yet paid */}
              {!item.cancelled && !item.payment && !item.isCompleted &&
                <button
              ...
              {/* Show Cancel only if not cancelled and not completed */}
